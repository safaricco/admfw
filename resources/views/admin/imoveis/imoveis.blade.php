                            ...
                            <tbody>
                                @foreach($imoveis as $imovel)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/imoveis/editar/' . $imovel->id_imovel) }}"><i class="fa fa-edit"></i> Editar </a>
                                            <a href="{{ url('admin/imoveis/destroy/' . $imovel->id_imovel) }}"><i class="fa fa-trash"></i>  Excluir </a>
                                            @if ($imovel->status == 1)
                                                <a href="{{ url('/admin/imoveis/status/0/' . $imovel->id_imovel) }}"><i class="fa fa-remove"></i> Desativar</a>
                                            @else
                                                <a href="{{ url('/admin/imoveis/status/1/' . $imovel->id_imovel) }}"><i class="fa fa-remove"></i> Ativar</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
